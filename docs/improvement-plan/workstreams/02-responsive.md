...
> Owner's exact requirement: _"this column should stack on mobile, but this column shouldn't — some columns can still be side by side on mobile, others shouldn't."_ So stacking is **per-column**, not all-or-nothing.
