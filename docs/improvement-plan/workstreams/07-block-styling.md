...
- [ ] **Email-safety guardrail:** some clients (Outlook) ignore `rgba`/8-digit hex. Document this; consider the editor color picker warning when alpha is used in a context Outlook will drop. Default editor picker stays hex but _allows_ alpha.
